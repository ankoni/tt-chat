...
import { ChatsUsersEffects } from './modules/chats-users/store/chats-users.effects'
import { chatsUserReducer } from './modules/chats-users/store/chats-users.reducer'
...
export const appConfig: ApplicationConfig = {
    providers: [
        ...
        provideStore({ auth: authReducer, user: userReducer, chat: chatReducer, chatsUsers: chatsUserReducer }),
